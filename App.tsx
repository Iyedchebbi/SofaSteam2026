  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-[#030712] overflow-x-hidden selection:bg-brand-500 selection:text-white">
      ...
      <div className={`fixed inset-0 z-40 bg-white/95 dark:bg-gray-950/95 backdrop-blur-2xl transition-all duration-300 lg:hidden flex flex-col justify-center items-center gap-8 ${isMenuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
          <div className="flex flex-col items-center gap-6 w-full px-6 max-h-[85vh] overflow-y-auto pt-20">
              {NAV_ITEMS.map(item => (
                  <a 
                      key={item.id}
                      href={item.href}
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
         ...
         <div className="container mx-auto px-6 relative z-10 pt-20 text-center">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-9xl font-display font-black text-white tracking-tight mb-10 leading-[1.1] sm:leading-[1] drop-shadow-2xl animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            ...
            {/* Subheadline */}
            <p className="text-lg sm:text-xl md:text-2xl text-gray-200 max-w-2xl mx-auto mb-14 leading-relaxed font-light animate-fade-in-up drop-shadow-md" style={{ animationDelay: '0.2s' }}>
      ...
      <section id="services" className="py-20 lg:py-32 bg-gray-50 dark:bg-[#030712] relative overflow-hidden">
         <div className="absolute top-0 right-0 w-[400px] lg:w-[800px] h-[400px] lg:h-[800px] bg-brand-500/5 rounded-full blur-[80px] lg:blur-[120px] -translate-y-1/2 translate-x-1/3"></div>
         <div className="absolute bottom-0 left-0 w-[300px] lg:w-[600px] h-[300px] lg:h-[600px] bg-purple-500/5 rounded-full blur-[60px] lg:blur-[100px] translate-y-1/2 -translate-x-1/3"></div>
            ...
            {loadingProducts ? (
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
                  {filteredProducts.map((product) => (
                     <div key={product.id} className="group bg-white dark:bg-gray-900 rounded-[2rem] lg:rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-white/5 hover:-translate-y-2 hover:border-brand-500/30 relative">
                        ...
                        <div className="p-6 sm:p-8 relative z-20 bg-white dark:bg-[#0B1120] transition-colors">
                           <p className="text-gray-600 dark:text-gray-400 mb-6 sm:mb-8 text-sm sm:text-base leading-relaxed line-clamp-3 font-light">
      ...
      <footer className="bg-black pt-20 lg:pt-40 pb-12 lg:pb-16 text-white relative overflow-hidden border-t border-white/10">
         ...
         <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-20 mb-20 lg:mb-32">
               ...
               {/* Column 1: Brand & Identity (Centered on mobile for impact) */}
               <div className="space-y-6 lg:space-y-8 flex flex-col items-center text-center md:items-start md:text-left">
                  <div className="flex items-center gap-4 h-12 mb-6"> {/* Fixed height for alignment */}
                     <div className="w-16 h-16 lg:w-20 lg:h-20">
                        <img src={LOGO_URL} className="w-full h-full object-contain" alt="Logo" />
                     </div>
                     <span className="text-2xl lg:text-3xl font-display font-black tracking-tight pt-2">{APP_NAME}</span>
                  </div>
               ...
               <div className="flex flex-col items-center md:items-start text-center md:text-left">
                  <h4 className="font-bold text-white mb-6 text-lg lg:text-xl flex items-center gap-3 font-display justify-center md:justify-start w-full h-12"> {/* Fixed height match */}
      ...
      <div id="ai-widget" className="fixed bottom-6 left-6 lg:bottom-8 lg:left-8 z-[50]">
          <button 
